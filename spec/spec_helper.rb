...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    stub_request(:post, "https://api-sandbox.wellsfargo.com/treasury/transaction-reporting/v3/transactions/search").
        with(
            body: "{\"datetime_range\":{\"start_transaction_datetime\":\"2019-09-11T00:00:00Z\",\"end_transaction_datetime\":\"2019-09-18T23:59:59Z\"},\"accounts\":[{\"bank_id\":\"111111111\",\"account_number\":\"2222222222\"},{\"bank_id\":\"111111111\",\"account_number\":\"3333333333\"}]}",
            headers: {
                'Accept' => '*/*',
                'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
                'Authorization' => 'Bearer bogustogus',
        ...
        to_return(status: 400, body: '{\"errors\":[{\"error_code\":\"1018-011\",\"description\":\"The requested date time range should be restricted to 7 days.\",\"api_specification_url\":\"https://devstore.wellsfargo.com\"}]}', headers: {})
    stub_request(:post, "https://api-sandbox.wellsfargo.com/token?grant_type=client_credentials&scope=TM-Transaction-Search").
        with(
            headers: {
                'Accept' => '*/*',
